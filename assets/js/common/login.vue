    ...
    <div class="modal-body">
        <validator name="v">
            <div class="input-group">
                ...
                <input type="text" class="form-control" placeholder="请输入用户名" aria-describedby="userName" v-model="userName" v-validate:name="{required:true}"
                    :class="{'red-border': $v.name && $v.name.touched && $v.name.invalid}" @keyup.enter="doLogin" />
            </div>
            ...
            <div class="input-group">
                ...
                <input type="password" class="form-control" placeholder="请输入密码" aria-describedby="password" v-model="password" v-validate:password="{required:true}"
                    :class="{'red-border': $v.password && $v.password.touched && $v.password.invalid}" @keyup.enter="doLogin"
                />
            </div>
