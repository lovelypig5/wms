            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                    <ul class="nav navbar-nav">
                        ...
                        <li v-link="{path: '/goods/list', activeClass: 'active'}"><a href="javascript:void(0)" v-if="user.id">{{ $t("goods") }}</a></li>
                        <li v-link="{path: '/order/list', activeClass: 'active'}"><a href="javascript:void(0)" v-if="user.id">{{ $t("order") }}</a></li>
                    </ul>
